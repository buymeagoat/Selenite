...
These steps assume the application is running via `start-selenite.ps1` and the tester is trying to access it from a phone on the same LAN or over Tailscale.
