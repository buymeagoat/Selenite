...
**File**: `src/components/modals/NewJobModal.jsx`
...
2. **Default Transcription Options**
   - Model dropdown
   - Language dropdown
   - Checkboxes for timestamps and speaker detection
...
6. **System**
   - Restart Server button (requires password)
   - Shutdown Server button (requires password)
