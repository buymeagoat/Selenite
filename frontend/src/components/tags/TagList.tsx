...
export const TagList: React.FC<TagListProps> = ({ tags, onEdit, onDelete }) => {
  ...
  return (
    <div className="bg-white border border-sage-mid rounded-lg overflow-hidden">
      {/* Desktop table view */}
      <table role="table" className="hidden md:table w-full">
      ...
      {/* Mobile card view */}
      <div className="md:hidden divide-y divide-sage-mid">
        {tags.map(tag => (
